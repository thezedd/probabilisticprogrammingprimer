...
def guide(data):
    """
    In order to do inference we’re going to need a guide, i.e. a parameterized family of 
    distributions over w and b. Writing down a guide will proceed in close analogy to the construction of our model, 
    with the key difference that the guide parameters need to be trainable.
    """
